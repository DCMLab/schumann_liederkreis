...
.. code:: bash
   ...
   git clone https://github.com/DCMLab/schumann_liederkreis.git
...
* `Robert Schumann – Liederkreis <https://github.com/DCMLab/schumann_liederkreis/archive/refs/heads/main.zip>`__


Data Formats
============

Each piece in this corpus is represented by five files with identical names, each in its own folder. For example, the first song, *In der Fremde*, has the following files:
...
.. code:: python
   ...
   labels = ms3.load_tsv('harmonies/op39n01.tsv')
   notes = ms3.load_tsv('notes/op39n01.tsv')
...
For questions, remarks etc., please `create an issue <https://github.com/DCMLab/schumann_liederkreis/issues>`__ and feel free to fork and submit pull requests.
